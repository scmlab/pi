...
parseProgram filePath src = C.toAbstract <$> runExcept (evalStateT programParser initState)
...
parseProcess src = C.toAbstract <$> runExcept (evalStateT processParser initState)
  where filePath = ""
